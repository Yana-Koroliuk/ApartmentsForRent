...
VALUES ('Vinnytsia, Kosmonavtiv Ave, 43, apt. 83', 100, '1965', 4000, 3, 2);

INSERT INTO details (address, area, year, price, floor, quantity_of_rooms)
VALUES ('Kyiv, Peremohy Street, 5, apt. 46', 100, '1995', 4000, 3, 2);

INSERT INTO details (address, area, year, price, floor, quantity_of_rooms)
VALUES ('Zhytomyr, Chornoi Ave, 12, apt. 90', 150.23, '1958', 1000, 5, 1);

INSERT INTO details (address, area, year, price, floor, quantity_of_rooms)
VALUES ('м. Київ, вул. Політехнічна, 41, кв. 316',  210.50, '1945', 7000, 4, 1);

INSERT INTO details (address, area, year, price, floor, quantity_of_rooms)
VALUES ('м. Київ, вул. Банкова, 11, кв. 1', 300, '1936', 1000000, 6, 10);

INSERT INTO descriptions (condition, building_type, additional_info)
